		...
		<section id="clients" class="clients">
			<div class="container" data-aos="zoom-in">
				...
				<div class="owl-carousel clients-carousel">
					<img src="/resources/assets/img/clients/client-1.png" alt=""> <img
						src="/resources/assets/img/clients/client-2.png" alt=""> <img
						src="/resources/assets/img/clients/client-3.png" alt=""> <img
						src="/resources/assets/img/clients/client-4.png" alt=""> <img
						src="/resources/assets/img/clients/client-5.png" alt=""> <img
						src="/resources/assets/img/clients/client-6.png" alt=""> <img
						src="/resources/assets/img/clients/client-7.png" alt=""> <img
						src="/resources/assets/img/clients/client-8.png" alt="">
				</div>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row">
					<div class="image col-lg-6"
						style='background-image: url("/resources/assets/img/features.jpg");'
		...
		<section id="portfolio" class="portfolio">
			<div class="container" data-aos="fade-up">
				...
				<div class="row portfolio-container" data-aos="fade-up"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app">
						<div class="portfolio-wrap">
							<img src="/resources/assets/img/portfolio/portfolio-6.jpg" class="img-fluid"
								alt="">
							<div class="portfolio-info">
								<h4>App 3</h4>
								<p>App</p>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card">
						<div class="portfolio-wrap">
							<img src="/resources/assets/img/portfolio/portfolio-8.jpg" class="img-fluid"
								alt="">
							<div class="portfolio-info">
								<h4>Card 3</h4>
								<p>Card</p>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web">
						<div class="portfolio-wrap">
							<img src="/resources/assets/img/portfolio/portfolio-9.jpg" class="img-fluid"
								alt="">
							<div class="portfolio-info">
								<h4>Web 3</h4>
								<p>Web</p>
		...
		<section id="counts" class="counts">
			<div class="container" data-aos="fade-up">
				...
				<div class="row no-gutters">
					...
					<div
						class="col-xl-7 pl-0 pl-lg-5 pr-lg-1 d-flex align-items-stretch"
